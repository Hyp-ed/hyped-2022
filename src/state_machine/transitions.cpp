                             ...
                             Sensors sensors_data, Motors motors_data)
{
  ...
  log.INFO(stm, m_calibrate_initialised);
  return true;
}
                       ...
                       Motors motors_data)
{
  ...
  log.INFO(stm, m_modules_calibrated);
  return true;
}
...
bool checkShutdownCommand(Logger &log, Telemetry telemetry_data)
{
  ...
  log.INFO(stm, m_shutdown_command);
  return true;
}
