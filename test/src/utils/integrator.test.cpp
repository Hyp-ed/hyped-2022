...
TEST(IntegratorFunctionalityTest, handlesInitializationTest){
  ...
  myAssert_EQ(0,output.value,"The first value should just change the lower bound of the integral, it should not affect the total area. Please review implementation");
  myAssert_EQ(pow(10, 6), output.timestamp,"The timeStep should change to the one given by the first point, Plese review implementation");
}
