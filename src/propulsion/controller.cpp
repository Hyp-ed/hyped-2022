  ...
  if (index_1 == 0x27 && index_2 == 0x20 && sub_index == 0x00) {
    if (message.data[4] != 0 && message.data[5] != 0) {
      ...
      switch (warning_message) {
        case 0x01:
          log_.error("Controller %d warning: Controller temperature exceeded");
          break;
        case 0x02:
          log_.error("Controller %d warning: Motor temperature exceeded");
          break;
        case 0x04:
          log_.error("Controller %d warning: DC link under voltage");
          break;
        case 0x08:
          log_.error("Controller %d warning: DC link over voltage");
          break;
        case 0x10:
          log_.error("Controller %d warning: DC over current");
          break;
        case 0x20:
          log_.error("Controller %d warning: Stall protection active");
          break;
        case 0x40:
          log_.error("Controller %d warning: Max velocity exceeded");
          break;
        case 0x80:
          log_.error("Controller %d warning: Bms proposed power");
          break;
        case 0x100:
          log_.error("Controller %d warning: Capacitor temperature exceeded");
          break;
        case 0x200:
          log_.error("Controller %d warning: I2T protection");
          break;
        case 0x400:
          log_.error("Controller %d warning: Field weakening active ");
          break;
        default:
